    ...
    <div className="min-h-dvh flex flex-col items-center justify-center px-6 py-12 bg-surface">
      ...
      <div className="w-full max-w-sm animate-fade-in-up" style={{ animationDelay: '0.05s' }}>
        <div className="auth-card p-7">
          ...
          <p className="text-on-surface-variant text-sm mb-6">Join CareConnect today</p>

          {error && (
            <div className="flex items-center gap-2 bg-error-container text-on-error-container px-4 py-3 rounded-xl mb-5 text-sm font-medium animate-shake">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              {password && (
                <div className={`flex items-center gap-1.5 text-xs mt-1.5 ${passwordChecks.length ? 'text-health' : 'text-outline'}`}>
            ...
            <div>
              ...
              />
              {confirmPassword && (
                <div className={`flex items-center gap-1.5 text-xs mt-1.5 ${passwordChecks.match ? 'text-health' : 'text-error'}`}>
                  <span className="material-symbols-outlined" style={{ fontSize: '14px' }}>
